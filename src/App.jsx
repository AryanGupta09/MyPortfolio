...
export default function App() {
  ...
  const projects = [
    {
      icon: "🏥", name: "SwasthAI – AI-Driven Health Platform", date: "Feb 2026",
      desc: "Full-stack AI fitness platform using MERN stack with secure JWT-based authentication and LLM-powered coaching.",
      features: [
        "MERN stack with secure JWT-based authentication",
        "RESTful APIs for user management, diet generation, and AI coaching",
        "LLM-based AI API for personalized diet plans and conversational fitness",
      ],
      tech: ["MongoDB", "Express.js", "React.js", "Node.js", "JavaScript", "CSS"],
      github: "https://github.com/AryanGupta09/SwasthAIFrontend",
      live: "https://swasth-ai-frontend.vercel.app",
    },
    {
      icon: "🌐", name: "Personal Portfolio", date: "Nov 2025",
      desc: "Responsive personal portfolio website built with React.js showcasing projects, skills, and achievements.",
      features: [
        "Built with React.js with reusable component architecture",
        "Modern UI/UX design with full mobile responsiveness",
      ],
      tech: ["React.js", "JavaScript", "CSS"],
      github: "https://github.com/AryanGupta09/MyPortfolio",
      live: "https://my-portfolio-three-beige-23.vercel.app",
    },
  ];
